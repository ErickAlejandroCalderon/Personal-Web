...
export default function Hero() {
  ...
  const codeContent = [
    ...
    {
      type: "code",
      text: '<span class="code-keyword">const</span> developer = {',
    },
    {
      type: "code",
      text: '  name: <span class="code-string">"Erick Calderón"</span>,',
    },
    {
      type: "code",
      text: '  role: <span class="code-string">"Systems Engineer"</span>,',
    },
    {
      type: "code",
      text: '  stack: [<span class="code-string">"React"</span>, <span class="code-string">"Java"</span>, <span class="code-string">"Docker"</span>],',
    },
    {
      type: "code",
      text: '  available: <span class="code-keyword">true</span>',
    },
    { type: "code", text: "};" },
  ];
      ...
      <div className="container hero-content">
        <div className="hero-text">
          ...
          <div className="hero-cta-group" style={{ opacity: 0 }}>
            <a
              href={`${import.meta.env.BASE_URL}cv-erick-calderon.pdf`}
              download
